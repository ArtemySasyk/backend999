    ...
    <div class="block_form" id="form">
        <div class="top_bot">
            ...
            <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" id="form">
                ...
                <label>В какую сферу хотите попасть:</label>
                <br />
                <select class="custom-select" name="superpower[]" required>
                    <option value="Бессмертие">Web разработка</option>
                    <option value="Прохождение сквозь стены">Мобильная разработка
                    <option value="Левитация">Тестинг</option>
                </select>
                <br />
                ...
                <div class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label" for="customCheck1">Условия прочитал</label>
                </div>
